...
class NivelDos:
    ...
    def __init__(self, iniciales, puntaje):
        ...
        self.musica_nivel_II = pg.mixer.Sound("sonidos/explosiones/11 die vonstantine.ogg")
        self.musica_nivel_II.play(-1)
        self.musica_nivel_II.set_volume(0.3)
        self.musica_nivel_II.stop()
        ...
        self.FPS = 60
        self.score = self.dicc_jugador['puntaje'] # Pintaje recibido de nivel I
        ...
        self.text = font.render("MISSION II", True, (255, 255, 255))
        ...
        self.ship = Ship(self.screen, self.screen_rect, 4)
        ...
        self.stars1 = Stars(self.ANCHO, self.ALTO, self.screen, colores.GRIS, 1, 1)
        self.stars2 = Stars(self.ANCHO, self.ALTO, self.screen, colores.GRIS, 0.5, 1)
        self.stars3 = Stars(self.ANCHO, self.ALTO, self.screen, colores.GRIS, 0.2, 1)
        ...
        self.alien_fleet = Alien_fleet(self.screen, 2, self.ANCHO, self.ALTO, self.bala_alien, 0.004)
    ...
    def colision_bala_jugador_con_alien(self):
        ...
        if len(nuevos_aliens) == 0 and alien['mostrar'] == False: # Si mate a todos los aliens:
            ...
            self.musica_nivel_II.stop() # Apaga música de partida

        if self.ganaste:
            self.dicc_jugador['puntaje'] = self.global_score
    ...
    def run(self):
        ...
        while self.running:
            ...
            puntaje = self.colision_bala_jugador_con_alien()
            self.fin_de_tiempo()
